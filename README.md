...
The Back end of Repleet uses ASP .Net Core for the backend, XUnit for Unit and Integration Tests, ASP Identity for Authentication, and Microsoft SQL Server for the Database. As of Now, it's deployed with Azure but I'm looking at using Docker Compose to deploy elsewhere. 
